...
- [ADR-0006: Bind approved selection to installation with a plan token](./0006-plan-token.md) — **Accepted**
...
- [ADR-0009: Use explicit harness adapters](./0009-harness-adapters.md) — **Accepted**
...
- [ADR-0012: Distribute Forge through npm and expose a stdio MCP server](./0012-node-npm-cli-and-mcp.md) — **Accepted**
